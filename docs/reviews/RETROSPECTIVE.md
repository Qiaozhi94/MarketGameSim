...
| agent-full-withdrawal-requote-never-wired | Critical | correctness | root-cause | process-gap | fixed | 18 | 18 | marked-done-not-implemented |
| chain-depth-parent-link-never-passed | High | correctness | root-cause | process-gap | fixed | 19 | 19 | marked-done-not-implemented |
| kpi-011-zero-sum-declaration-missing | High | correctness | root-cause | process-gap | fixed | 21 | 21 | marked-done-not-implemented |
