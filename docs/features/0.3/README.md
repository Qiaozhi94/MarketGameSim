...
提供导航，不复制状态或需求正文。**v0.3 已于 2026-09-20 签收**，收口记录见
[`releases/0.3.md`](../releases/0.3.md)。
...
| [`0.3.2-web-trading-terminal/`](0.3.2-web-trading-terminal/spec.md) | done | 本地 Web 交易终端：价格/K 线/下单/preview 门控与会话审计链 |

## 边界

- `0.3.1` 只收口 H2 AI 正式机制轨的 168 个 paired-seed blocks；所有者训练和正式 N-of-1
  采集由 `0.3.2` 承担，不阻塞 AI 研究包交付。
- `0.3.2` 只服务项目所有者本人，交付可见价格、K 线与交互下单；其 N-of-1 采集轨
  （6 训练 + 24 正式场景）随 [`ADR-010`](../../decisions/010-market-ecology-research-pivot.md)
  归档，是范围裁决而非未达标，机械与测试保留在仓库。
