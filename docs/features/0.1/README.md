...
面向用户的阶段产物、投入估算和交易者介入顺序统一见
[`PRD §15`](../../market-game-sim-prd.md#15-交付路线图)；本目录继续只拥有工程与研究
验收状态。
...
| [`0.1.5-goal-driven-flagship/`](0.1.5-goal-driven-flagship/spec.md) | done | 1 |
...
**v0.1 已签收**：0.1.1—0.1.5 全部退出条件通过，0.1.5 的研究声明已建立，版本根
`spec.md` 为 `done / established`。不可变签收信息见
[`docs/features/releases/0.1.md`](../releases/0.1.md)；本目录路径保持不变，不做物理 archive。
